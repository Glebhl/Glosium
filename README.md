...
LexiForge is a desktop prototype for AI-assisted language learning built with `PySide6`, `Qt WebEngine`, and an HTML/CSS/JavaScript UI. The app lets a learner describe what they want to study, streams vocabulary cards generated by OpenAI, and then builds a lesson from those cards.
